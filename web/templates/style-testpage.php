...
function get_svg($filename, $directory = 'icons') {
    $filepath = __DIR__ . '/images/' . $directory . '/' . $filename . '.svg';

    if (file_exists($filepath)) {
        return file_get_contents($filepath);
    } else {
        error_log("SVG not found: $filepath");
        return '';
    }
}
