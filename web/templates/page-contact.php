        ...
        <div class="contactpage-coworker-view">
            ...
            if ($coworkers) :
                ...
                while ($current_index < count($coworkers)) :
                    ...
                    $offset = $offset_map[$actual_count] ?? 0;
                    ?>

                    <div class="row small-gutters justify-content-center">
                        <?php foreach (array_values($row_items) as $i => $coworker) :
                            ...
                            } elseif ($i === $actual_count - 1) {
                                $corner_class = 'corner-tr';
                            }
                            ?>
                            <div class="col-12 col-sm-6 col-lg-3 mt-16 <?= $offset_class ?>">
